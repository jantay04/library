...
const AboutUs = (props: Props) => {
  return (
    <MainLayout>
      <div className="ml-aa20">
        <BreadCrumb />
        <div className="text-ourBlue text-xl font-medium mt-5">
          <h1 className="font-extrabold text-3xl text-ourBlue">O HAC</h1>
          <p className="mt-6 font-bold inline-block ">Your </p>
          <p className="font-bold text-ourOrange inline-block ml-1">Books</p> -
          онлайн библиотека.
          <p className="mt-6">
