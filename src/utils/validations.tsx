...
export const PersonalAreaFormSchema = yup.object({
    ...
    passwordConfirm: yup.string().oneOf([yup.ref('password')], 'Пароль должен совподать').required("Пароль должен совподать"),
}).concat(LoginFormSchema);