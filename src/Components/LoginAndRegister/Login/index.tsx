      ...
      >
        <Form className='flex gap-[10px] flex-col mt-11'>
          ...
          <TextField
            ...
            type="password"
          />
          <p onClick={setFormResetPassword} className='text-xs text-right underline cursor-pointer text-[#8E949A]'>Забыли пароль</p>
          ...
          <Button onClick={setFormRegister} className='rounded-lg' color='secondary' variant="outlined" size='large' sx={{ textTransform: "capitalize", borderRadius: 2 }}>
            Зарегистрироваться
          </Button>
        </Form>
      </Formik>
